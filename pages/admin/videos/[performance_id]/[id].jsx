...
export default function ManageVideos() {
    ...
    let { data, error, mutate } = useSWR('https://api.theskets.com/v1/private/admin/get_videos?performance_id='+router.query.performance_id+'&video_id='+router.query.id, fetcher)
